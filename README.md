...
```bash
cd /home/awaka/stock/stock_list
...
```bash
cd /home/awaka/stock/stock_list/stock_theme_dashboard
...
```bash
cd /home/awaka/stock/stock_list/stock_theme_dashboard
/home/awaka/stock/stock_list/stock_list/bin/python scripts/update_dashboard_data.py
```
